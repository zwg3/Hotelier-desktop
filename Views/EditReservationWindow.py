...
class Ui_EditResWindow(object):
    def setupUi(self, EditResWindow):
        ...
        self.doa_daddit.setDateTime(QtCore.QDateTime(QtCore.QDate(2023, 12, 27), QtCore.QTime(6, 0, 0)))
        ...
        self.dod_daddit.setDateTime(QtCore.QDateTime(QtCore.QDate(2023, 12, 27), QtCore.QTime(6, 0, 0)))
