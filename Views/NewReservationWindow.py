...
class Ui_NewResWindow(object):
    def setupUi(self, NewResWindow):
        ...
        self.doa_daddit.setDateTime(QtCore.QDateTime(QtCore.QDate(2023, 12, 27), QtCore.QTime(0, 0, 0)))
        ...
        self.dod_daddit.setDateTime(QtCore.QDateTime(QtCore.QDate(2023, 12, 27), QtCore.QTime(0, 0, 0)))
